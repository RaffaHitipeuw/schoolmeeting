    ...
    socket.emit(
      ...
      (res) => {
        ...
        update({
          ...
          chat: res.chat,
          teacherSocketId: res.teacherSocketId,
          connected: true,
        });
        onEnter();
      }
      ...
      <div style={s.card} className="animate-fade-up">
        ...
        <div style={s.header}>
          ...
          <div>
            ...
            <div style={s.subtitle}>Platform meeting sederhana untuk kelas</div>
          </div>
        </div>
        ...
        {tab === "create" && (
          <div className="animate-fade-in">
            <div style={s.infoBox}>
              ...
              <div>
                Kamu akan menjadi <strong>guru</strong> dan mendapat kode room unik untuk
                dibagikan ke siswa. Video kamu akan otomatis dikirim ke semua peserta.
              </div>
            </div>
            <button
              className="btn-primary"
        ...
        <div style={s.footer}>
          WebRTC · End-to-end · Tidak perlu akun
        </div>
      </div>
    </div>
  );
...
const s = {
  ...
  card: {
    ...
    padding: "36px 32px",
    width: 430,
    boxShadow: "0 0 0 1px rgba(255,255,255,0.03), var(--shadow-lg)",
  },
  header: {
  ...
  iconWrap: {
    fontSize: 32,
    background: "linear-gradient(135deg, var(--accent-lo), #8b5cf620)",
    border: "1px solid var(--border2)",
  ...
  subtitle: { fontSize: 13, color: "var(--text2)", marginTop: 3 },
  errorBox: {
